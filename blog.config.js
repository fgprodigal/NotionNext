...
const BLOG = {
  ...
  NOTION_PAGE_ID:
    process.env.NOTION_PAGE_ID || '8b179ac560504f8c887690fe2bd41d2b',
  ...
  BIO: process.env.NEXT_PUBLIC_BIO || 'Love technology, love life.', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://blog.rayw.tech', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, 博客, fgprodigal, Ray', // 网站关键词 英文逗号隔开
  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || '', // 邮箱地址 例如mail@tangly1024.com
  CONTACT_WEIBO: process.env.NEXT_PUBLIC_CONTACT_WEIBO || '', // 你的微博个人主页
  CONTACT_TWITTER: process.env.NEXT_PUBLIC_CONTACT_TWITTER || '', // 你的twitter个人主页
  CONTACT_GITHUB:
    process.env.NEXT_PUBLIC_CONTACT_GITHUB || 'https://github.com/fgprodigal', // 你的github个人主页 例如 https://github.com/tangly1024
  ...
  FONT_URL: [
    ...
    'https://fonts.loli.net/css2?family=Lora:wght@400;600;700&family=Noto+Serif+SC:wght@400;600;700&display=swap',
